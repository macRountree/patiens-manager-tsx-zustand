    ...
    <div className=" md:mt-10 mt-10">
      ...
      <div className="flex justify-center gap-5 py-5 ">
        <a
          ...
          target="_blank"
          className="hover:cursor-pointer hover:scale-110 hover:shadow-sm transition-transform duration-300 hover:text-white "
        >
        ...
        <a
          ...
          target="_blank"
          className="hover:scale-110 hover:shadow-sm transition-transform duration-300 hover:text-white "
        >
